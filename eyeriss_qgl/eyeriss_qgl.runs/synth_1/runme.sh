...
HD_PWD='E:/yanjiusheng/study/fpga/eyeriss_qgl/eyeriss_qgl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eyeriss_qgl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eyeriss_qgl.tcl
